...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-silence-5ab2)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/frosty-silence-5ab2#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-silence-5ab2
```

A live public deployment of this template is available at [https://frosty-silence-5ab2.templates.workers.dev](https://frosty-silence-5ab2.templates.workers.dev)
